...
import com.prestrive.blog.common.lang.vo.VisitorNum;
...
public class VisitorController {
    ...
    public Result getAllVisitorList(){
    ...
    public Result getVisitorListByTime(@RequestParam(defaultValue = "") String time,@RequestParam(defaultValue = "1") Integer currentPage,@RequestParam(defaultValue = "10") Integer pageSize) {
        ...
        Page page = new Page(currentPage, pageSize);
        IPage pageData = visitorService.page(page, new QueryWrapper<Visitor>()
                .between("last_time",startEndTime[0],startEndTime[1])
                //.le("last_time",startEndTime[1])
                //.ge("last_time",startEndTime[0])
